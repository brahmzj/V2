...
(function () {
  ...
  const translations = {
    en: {
      ...
      // Developer multipliers: label updates to indicate they are locked.
      'label.tapMult': 'Qi per tap ×100 (locked)',
      'label.psMult': 'Qi per second ×100 (locked)',
      'btn.exportSave': 'Export Save',
      'btn.importSave': 'Import Save',
      'btn.resetGame': 'Reset Game',
      'btn.ok': 'OK',
      // Toast shown when the player enters an invalid password for developer toggles
      'toast.invalidPassword': 'Incorrect password',
    ...
    fr: {
      ...
      'label.tapMult': 'Qi par tap ×100 (verrouillé)',
      'label.psMult': 'Qi par seconde ×100 (verrouillé)',
    ...
    es: {
      ...
      'label.tapMult': 'Qi por toque ×100 (bloqueado)',
      'label.psMult': 'Qi por segundo ×100 (bloqueado)',
    ...
    zh: {
      ...
      'label.tapMult': '每次点击气 ×100（锁定）',
      'label.psMult': '每秒气 ×100（锁定）',
      'btn.exportSave': '导出存档',
      'btn.importSave': '导入存档',
      'btn.resetGame': '重置游戏',
      'btn.ok': '确定',
    ...
    hi: {
      ...
      'label.tapMult': 'प्रत्येक टैप पर क्यूई ×100 (लॉक)',
      'label.psMult': 'प्रति सेकंड क्यूई ×100 (लॉक)',
